...
// Função para ler o arquivo .txt e preencher a árvore binária AVL
double lerArquivoDeInsercao(const char *nomeArquivoArtista, const char *nomeArquivoAlbum, const char *nomeArquivoMusicas, Artista **raiz) {
    // Ler arquivo de artistas
    FILE *arquivo_atistas = fopen(nomeArquivoArtista, "r");
    if (arquivo_atistas == NULL) {
    ...
    while (fgets(linha, sizeof(linha), arquivo_atistas)) {
        ...
        // 10000 artistas * 100 albuns * 3 musicas = 3000000 insercois
...
int main() {
    Artista *raiz = NULL;
    const char *nomeArquivoArtista = "/home/sthefany/Documentos/4Periodo/ED_II/Trabalho_version_Finish/teste/10000_artistas.txt"; // Nome do arquivo
    ...
    const char *nomeArquivoBusca = "/home/sthefany/Documentos/4Periodo/ED_II/Trabalho_version_Finish/teste/teste_de_busca_10000artistas.csv"; // Nome do arquivo
    double tempoInsercao = 0.0;
    double tempoBusca = 0.0;
    
    // Ler o arquivo e preencher a árvore binária AVL
    ...
    // Garantir que a árvore AVL esteja vazia
